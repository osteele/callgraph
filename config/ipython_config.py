...
# c.TerminalInteractiveShell.editor = 'subl -n -w'

# Highlight matching brackets .
# c.TerminalInteractiveShell.highlight_matching_brackets = True

# The name of a Pygments style to use for syntax highlighting:  tango, xcode,
# friendly, perldoc, borland, algol_nu, pastie, igor, fruity, autumn, paraiso-
# dark, trac, monokai, colorful, manni, default, lovelace, vs, paraiso-light,
# vim, bw, rrt, algol, emacs, native, murphy
...
# Number of line at the bottom of the screen to re` for the completion menu
